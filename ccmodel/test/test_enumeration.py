...
class TestCCModelEnum(CCModelTest):
    ...
    def test_enumeration_data(cls_type, lps):
        ...
        assert enum1.fields["A"].value == 0
        assert enum1.fields["A"] is summary["testEnum1::A"]

        assert enum1.fields["B"].value == 1
        assert enum1.fields["B"] is summary["testEnum1::B"]

        assert enum1.fields["A"].id == 'A'
        assert enum1.fields["A"].scoped_id == 'testEnum1::A'
        assert enum1.fields["A"].scoped_displayname == 'testEnum1::A'

        assert enum1.fields["B"].id == "B"
        assert enum1.fields["B"].scoped_id == "testEnum1::B"
        assert enum1.fields["B"].scoped_displayname == "testEnum1::B"
        ...
        assert enum3.fields["A1"].value == 0
        assert enum3.fields["A1"] is summary["Nest1::testEnum3::A1"]

        assert enum3.fields["A2"].value == 1
        assert enum3.fields["A2"] is summary["Nest1::testEnum3::A2"]
        
        assert enum3.fields["A3"].value == 2
        assert enum3.fields["A3"] is summary["Nest1::testEnum3::A3"]
        
        assert enum3.fields["A4"].value == 4
        assert enum3.fields["A4"] is summary["Nest1::testEnum3::A4"]

        assert enum3.fields["A1"].id == 'A1'
        assert enum3.fields["A1"].scoped_id == 'Nest1::testEnum3::A1'
        assert enum3.fields["A1"].scoped_displayname == 'Nest1::testEnum3::A1'

        assert enum3.fields["A2"].id == "A2"
        assert enum3.fields["A2"].scoped_id == "Nest1::testEnum3::A2"
        assert enum3.fields["A2"].scoped_displayname == "Nest1::testEnum3::A2"
       
        assert enum3.fields["A3"].id == "A3"
        assert enum3.fields["A3"].scoped_id == "Nest1::testEnum3::A3"
        assert enum3.fields["A3"].scoped_displayname == "Nest1::testEnum3::A3"

        assert enum3.fields["A4"].id == "A4"
        assert enum3.fields["A4"].scoped_id == "Nest1::testEnum3::A4"
        assert enum3.fields["A4"].scoped_displayname == "Nest1::testEnum3::A4"
