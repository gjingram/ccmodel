...
class TestCCModelVariable(CCModelTest):
    ...
    def test_variable_data(cls_type, lps):
        ...
        assert var1.member == False
        assert var1.const == False
        assert var1.id == "var1"
        ...
        assert var2.member == False
        assert var2.const == False
        assert var2.id == "var2"
        ...
        assert var3.member == False
        assert var3.const == False
        assert var3.id == "var3"
        ...
        assert var4.member == False
        assert var4.const == False
        assert var4.id == "var4"
        ...
        assert var5.member == False
        assert var5.const == False
        assert var5.id == "var5"
        ...
        assert var6.member == False
        assert var6.const == False
        assert var6.id == "var6"
        ...
        assert var7.member == False
        assert var7.const == False
        assert var7.id == "var7"
        ...
        assert var8.member == False
        assert var8.const == False
        assert var8.id == "var8"
        ...
        assert var9.member == False
        assert var9.const == False
        assert var9.id == "var9"
        ...
        assert var10.member == False
        assert var10.const == False
        ...
        assert var11.member == False
        assert var11.const == True
        ...
        assert var12.member == False
        assert var12.const == False
        ...
        assert var13.member == False
        assert var13.const == True
